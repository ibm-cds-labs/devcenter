...
var generateSearchIndex = function(schema, callback) {
  ...
  // create  a default index on all the fields
  func2 += '  delete doc._id;\n';
  func2 += '  delete doc._rev;\n';
  func2 += '  var str = "";\n';
  func2 += '  for(var key in doc) {\n';
  func2 += '    if(doc[key]) {\n';
  func2 += '      str += doc[key].toString() +" ";\n';
  func2 += '    }\n';
  func2 += '  }\n';
  func2 += '  indy("default", str, false);\n';
  func2 += '  indy("date", parseInt(doc.updated_at.substring(0,19).replace(/[^0-9]/g, "")), false); '
  func2 += '}\n';
